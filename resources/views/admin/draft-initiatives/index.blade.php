<x-layout>
    ...
    @php
        ...
        $implementationStatuses = \App\Models\ImplementationStatus::all();
    @endphp

    <x-partials.draft_initiative_modal :objectives="$objectives" :directorates="$directorates" :implementationStatuses="$implementationStatuses" />
