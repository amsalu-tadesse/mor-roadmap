<x-layout>
    <x-breadcrump title='Add New Request Status' parent='Request Statuses' child='Add New' index="request-statuses" />
    ...
    <div class="card card-info">
        ...
        <form action="{{ route('admin.request-statuses.store') }}" method="post">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
