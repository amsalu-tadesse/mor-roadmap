                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="request_status_id" class="form-control @error('request_status_id') is-invalid @enderror" id="request_status_id">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="activities" class="form-control @error('activities') is-invalid @enderror" id="activities" rows="4" placeholder="Enter Activities">{{ old('activities') }}</textarea>
                            @error('activities')
                                <span class="invalid-feedback d-block">{{ $message }}</span>
                            @enderror
                        </div>
