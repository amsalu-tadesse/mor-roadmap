...
class RegionsDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn("color",function($regions){
            ...
            ->addColumn('action', function ($regions) {
                return view('components.action-buttons', [
                    'row_id' => $regions->id,
                    'permission_delete'=>'region: delete',
                     'permission_edit'=>'region: edit',
                     'permission_view'=>'region: view',
                ]);
            })
            ->rawColumns(['no', 'action','color']);
    }
